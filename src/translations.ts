const translations = {
  ar: {
    ...
    "consultation.subtitle":
      "نقدم لك استشارة شخصية مجانية لمناقشة احتياجاتك وكيف يمكننا مساعدتك",
    "consultation.formTitle": "طلب استشارة",
    "consultation.formDesc": "املأ النموذج وسنتواصل معك لتحديد موعد مناسب",
    "consultation.name": "الاسم الكامل",
    "consultation.namePlaceholder": "أدخل اسمك الكامل",
    "consultation.email": "البريد الإلكتروني",
    "consultation.emailPlaceholder": "example@email.com",
    "consultation.phone": "رقم الهاتف",
    "consultation.phonePlaceholder": "+966 XX XXX XXXX",
    ...
    "consultation.fields.manufacturing": "تحسين التصنيع",
    ...
    "consultation.success":
      "تم إرسال طلبك بنجاح! ستتلقى تأكيدًا عبر البريد الإلكتروني",
  ...
  en: {
    ...
    "services.consulting.2":
      "Ensuring consistent quality management across operations",
    "services.consulting.3":
    ...
    "projects.stats.completion": "Completion Rate",
    ...
    "consultation.subtitle":
      "We offer you a free personal consultation to discuss your needs and how we can help",
    "consultation.formTitle": "Request Consultation",
    "consultation.formDesc":
      "Fill out the form and we will contact you to schedule a suitable time",
    "consultation.name": "Full Name",
    "consultation.namePlaceholder": "Enter your full name",
    "consultation.email": "Email",
    "consultation.emailPlaceholder": "example@email.com",
    "consultation.phone": "Phone Number",
    "consultation.phonePlaceholder": "+1 (555) XXX-XXXX",
    ...
    "consultation.fields.manufacturing": "Manufacturing Optimization",
    ...
    "consultation.success":
      "Your request has been submitted successfully! You will receive a confirmation via email",
    "consultation.error":
    ...
    // Teamwork Quote
    "teamwork.quote":
      "Success is not achieved alone, but through collaboration and teamwork we reach the top",
    ...
    "footer.desc":
      "Your trusted partner in industrial solutions and operational excellence.",
